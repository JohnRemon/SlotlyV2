...
@Service(StrategyType.WEEKLY_OCCURRENCES)
public class WeeklyOccurrencesStrategy implements RecurrenceStrategy {
    ...
    public List<Slot> generateSlots(Event event) {
        ...
        return slotUtils.buildRecurringSlotsByOccurrences(event, RecurrenceFrequency.WEEKLY,
