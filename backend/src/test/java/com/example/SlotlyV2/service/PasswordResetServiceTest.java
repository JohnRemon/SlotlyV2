...
public class PasswordResetServiceTest {
    ...
    @BeforeEach
    void setUp() {
        reset(userRepository, passwordEncoder, verificationTokenService, applicationEventPublisher);
    }
    ...
    void shouldThrowInvalidTokenExceptionForInvalidPasswordResetToken() {
        ...
        // Act & Assert
        assertThrows(InvalidTokenException.class, () -> passwordResetService.resetPassword(anyString(), request));
    }
